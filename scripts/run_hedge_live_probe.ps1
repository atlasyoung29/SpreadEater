...
Write-Host "Running armed hedge live probe with scenario: $scenarioPath"
& cargo test --bin spreadeater live_probe_armed_runs_current_production_hedge_path -- --ignored --nocapture
